...
module.exports = {
  ...
  userPrincipalName: process.env.USER_PRINCIPLE_NAME || 'azzzx1@outlook.com',
  ...
  protectedRoutes: ['/Private', '/Demo/😎Another Private Folder Password 123','/Programs/tim'],

  // [OPTIONAL] Use "" here if you want to remove this email address from the nav bar.
  email: 'https://qsim.top/#contact',
